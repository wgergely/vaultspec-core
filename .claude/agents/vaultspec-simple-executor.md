...
description: Simple-tier implementation specialist for straightforward edits, documentation
  updates, and low-risk logic changes. Use for clear-cut tasks that follow well-defined
  patterns.
kind: local
...
- **Concise Documentation**: For every step, **UPDATE** or **CREATE** `<Step Record>` (`.vault/exec/yyyy-mm-dd-<feature>/yyyy-mm-dd-<feature>-<phase>-<step>.md`).
