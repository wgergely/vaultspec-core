---
description: "Use this skill to audit and clean the .docs vault. Validates frontmatter, wiki-links, naming conventions, template compliance, and directory structure. Fixes violations in-place and produces an audit report."
---

# Documentation Curation Skill (task-curate)

This skill governs the autonomous auditing and maintenance of the `.docs/` documentation vault. It ensures every artifact conforms to the project's documentation standards as defined in `.rules/templates/README.md`.

**Announce at start:** "I'm using the `task-curate` skill to audit and clean the documentation vault."

## When to Use

- After completing a feature (post `task-execute`) to verify documentation trail integrity.
...
`.docs/exec/yyyy-mm-dd-docs-curation/yyyy-mm-dd-docs-curation-audit.md`
...
- **Standards-first**: All fixes trace back to rules in `.rules/templates/README.md` and the canonical templates.
