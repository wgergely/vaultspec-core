...
<High-level description of HOW it will be implemented. Reference <research> and <reference> specs.>

## Rationale

<Why this option was chosen. Reference <research> findings and external <reference> patterns.>
