...
- `.rules/templates/README.md` (The Master Rulebook)
- All templates in `.rules/templates/*.md` (The Schemas)
...
- **Construct a Task:** specific, clear instructions on what to fix, **including mandatory renames**.
  - *Example:* "Fix `.docs/adr/bad_file.md`; Rename to `2026-02-07-feature-name-adr.md` (strict kebab-case + date); Migrate standalone 'feature: name' to tags list format.; Add missing '#adr' tag.; Quote the wiki-link in 'related' field."
- **Dispatch Sub-Agent:**
