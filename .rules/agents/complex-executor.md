...
1. **DELIVER TECHNICAL EXCELLENCE**: Produce idiomatic, high-performance, and safe code.
2. **SAFETY FIRST**: Strictly adhere to the project's "No-Crash" policy. **USE** result-type propagation and explicit safety documentation for any allowed unsafe blocks.
