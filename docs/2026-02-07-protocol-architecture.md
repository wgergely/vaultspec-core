...
> Full survey: [2026-02-07-multi-agent-orchestration-survey.md](./2026-02-07-multi-agent-orchestration-survey.md)
...
| Document | Scope |
|---|---|
| [Protocol Review](./2026-02-07-protocol-review.md) | Initial ACP vs A2A analysis and architectural diagnosis |
| [ACP Protocol Reference](./2026-02-07-acp-protocol-reference.md) | Full ACP spec: init, sessions, prompts, tools, permissions, proxy chains, SDKs |
| [A2A Protocol Reference](./2026-02-07-a2a-protocol-reference.md) | Full A2A spec: RPCs, task states, data types, Agent Cards, SDKs |
| [Multi-Agent Orchestration Survey](./2026-02-07-multi-agent-orchestration-survey.md) | Cross-framework comparison: Claude Teams, OpenAI, LangGraph, Magentic-One, CrewAI, ADK |
| [Frontier Landscape](./2026-02-07-frontier-landscape.md) | Three ACPs, proxy chains, SymmACP, IETF drafts, gaps, three-layer stack |
