...
from ...protocol.providers import ClaudeModels
...
class TestIncrementalRules:
    ...
    def test_cross_destination_consistency(self):
        ...
        for tool_dir in [".claude", ".gemini", ".agent"]:
            ...
            _meta, body = parse_frontmatter(p.read_text(encoding="utf-8"))
...
class TestIncrementalSkills:
    ...
    def test_skill_lifecycle(self):
        ...
        # Add skill
        deploy_dir = skills_dir / "vaultspec-deploy"
        ...
        test_dir = skills_dir / "vaultspec-test"
...
class TestMixedOperations:
    ...
    def test_full_mixed_lifecycle(self):
        ...
        build_skill_dir = skills_dir / "vaultspec-build"
        build_skill_dir.mkdir(parents=True)
        (build_skill_dir / "SKILL.md").write_text(
