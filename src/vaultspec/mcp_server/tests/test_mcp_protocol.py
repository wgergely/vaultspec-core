...
class TestProtocolCallTool:
    ...
    async def test_list_agents_via_call_tool(self, baker_cache):
        ...
        data = json.loads(result["result"])  # ty: ignore[not-subscriptable,invalid-argument-type]
...
class TestProtocolRoundTrip:
    ...
    async def test_dispatch_poll_complete_cycle(self, baker_cache, fresh_engine):
        ...
        dispatch_data = json.loads(dispatch_result["result"])  # ty: ignore[not-subscriptable,invalid-argument-type]
        ...
        status_data = json.loads(status_result["result"])  # ty: ignore[not-subscriptable,invalid-argument-type]
