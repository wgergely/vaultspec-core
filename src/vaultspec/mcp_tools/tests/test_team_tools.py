...
from vaultspec.mcp_tools.team_tools import (
    _load_session,
    _save_session,
    broadcast_message,
    dispatch_task,
...
from vaultspec.protocol.a2a.tests.conftest import EchoExecutor, PrefixExecutor
...
class _MuxTransport(httpx.AsyncBaseTransport):
    ...
    def __init__(self, routes: dict[str, object]) -> None:
        ...
        for base_url, app in routes.items():
            self._transports[base_url] = httpx.ASGITransport(app=app)
...
class TestDispatchTask:
    ...
    async def test_dispatch_to_echo_agent(self, workspace, echo_server_a):
        ...
        from vaultspec.orchestration.team import extract_artifact_text
...
class TestParseAgentUrls:
    ...
    def test_host_port_pairs(self):
        from vaultspec.mcp_tools.team_tools import _parse_agent_urls
