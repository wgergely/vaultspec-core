---
name: vaultspec-team
description: Form and manage a multi-agent team to perform complex, parallelizable
  tasks. Use this skill when a task is too large for a single sub-agent or benefits
