...
description: Begin a comprehensive marketing audit using a supervised team of agents.
  Assesses release readiness, packaging, competitive positioning, and feature gap
  analysis.
---
