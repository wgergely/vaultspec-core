...
Formalize the markdown rule system into a Python backend API and provide a unified CLI tool (`docs.py`) for auditing and managing the `.docs/` universe.
...
- [x] **Template Logic**: Implement hydration system for `.rules/templates/`.
