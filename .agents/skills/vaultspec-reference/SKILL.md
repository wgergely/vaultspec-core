...
- Auditing, researching, or implementing a specific technical implementation.
  How does this project achieve this feature?
- Auditing or researching a codebase to make architectural decisions. How
  does this project structure its code?
- Ensuring we do not miss implementation aspects or details. Did we implement
  all the required traits and features?
- Auditing or researching codebase for technical details. How does this
  project optimize this feature?

Invoke when a `vaultspec-research` -> `vaultspec-adr` -> `vaultspec-write`
workflow is explicitly investigating a reference project or codebase.

**Announce at start:** "I'm using the `vaultspec-reference` skill to find
