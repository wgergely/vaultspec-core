...
2. **Builtin marker**: files ending in `.builtin.md` could have originals bundled in the package. Revert = copy from package.
3. **Shadow copy**: maintain `.vaultspec/.backup/` with pre-edit copies. Adds complexity.
