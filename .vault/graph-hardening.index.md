...
# `graph-hardening` feature index

Auto-generated index of all documents tagged with `#graph-hardening`.

## Documents

### adr

- `2026-03-22-graph-hardening-adr` - `graph-hardening` adr: phantom nodes and dangling-link resolution | (**status:** `accepted`)

### audit

- `2026-03-22-graph-hardening-phase1-audit` - `graph-hardening` code review - phase 1

### exec

- `2026-03-22-graph-hardening-phase1-exec` - `graph-hardening` phase 1: phantom nodes in the graph
- `2026-03-22-graph-hardening-phase2-exec` - graph-hardening phase 2 - guards and metrics
- `2026-03-22-graph-hardening-phase3-exec` - graph-hardening phase3 - rendering
...
- `2026-03-22-graph-hardening-research` - `graph-hardening` research: phantom nodes and broken-link visibility
