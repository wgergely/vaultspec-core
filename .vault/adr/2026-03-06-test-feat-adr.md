...
# REFERENCE: #adr #audit #exec #plan #reference #research #test-feat
# Directory tag (hardcoded - DO NOT CHANGE - based on .vault/adr/ location)
# Feature tag (replace test-feat with your feature name, e.g., #editor-demo)
tags:
  - "#adr"
  - "#test-feat"
...
# `test-feat` adr: `My Title` | (**status:** `{accepted|rejected|deprecated}`)
