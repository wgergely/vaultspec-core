...
1. **Sub-Agent Injection:** Since `skills-ref` is specific to skills, we will programmatically generate a parallel XML structure for sub-agents to maintain consistency.
