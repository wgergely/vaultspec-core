...
2. **The real 60s overhead is ACP handshake timeout.** The subagent dispatch via
...
3. **torch import hangs (not just slow).** This suggests a CUDA 13.0 driver
...
2. **Fix ACP handshake resilience**: The dispatch_agent timeout is the likely
