...
- References: [[2026-02-22-protocol-stack-deep-audit-adr]] Decision 3b
  ...
  **Change:** Refactor each function to:
  ...
  2. Launch the coordinator dispatch in a background asyncio task
  3. Return `{"status": "working", "taskId": ...}` immediately
  4. On completion, store results via `TeamTaskEngine.complete_task()`
