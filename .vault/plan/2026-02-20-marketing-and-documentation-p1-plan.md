...
- `Phase 2: Create .vaultspec/docs/`
    ...
    3. Create `search-guide.md`. Structure: existing search guide minus the configuration table.
       - Copy all content from `docs/search-guide.md`.
       - Remove the `## Configuration` section at the bottom (the table of VAULTSPEC_* vars).
...
- `Phase 4: Update .vaultspec/README.md`
    ...
    2. Do not otherwise alter `.vaultspec/README.md` content. The overview, agent table,
...
2. Phase 1 (retire) — deletes source files after Phase 2 is complete
3. Phase 3 and Phase 4 — fully independent; run in parallel
