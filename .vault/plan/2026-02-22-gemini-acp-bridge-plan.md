...
1. Update `GeminiProvider` to spawn the bridge instead of the raw CLI.
1. Add rigorous test coverage for the new bridge.
1. Enable session resume in `GeminiA2AExecutor`.
