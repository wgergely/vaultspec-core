...
- Phase 1 — Engine Hardening
  ...
  1. Task 1b: Platform safety — fix shlex for Windows
  1. Task 1c: Agent dispatch — fix broken subagent invocation
  1. Task 1d: Remove YAML fallback parser
  1. Task 1e: Deduplicate yaml/yml hook loading
  1. Task 1f: Re-entrant trigger safety guard
- Phase 2 — Auto-Trigger Wiring
  1. Task 2a: Wire lifecycle hook triggers into CLI commands
  1. Task 2b: Remove dead vault.document.modified event
- Phase 3 — Tests and Documentation
  1. Task 3a: Test hardening
  1. Task 3b: Documentation
