...
1. **Worked Example section**: Added a new `## Worked Example` section between "The Workflow"
...
1. **Documentation links updated**: Replaced `docs/*.md` links with `.vaultspec/docs/*.md`
