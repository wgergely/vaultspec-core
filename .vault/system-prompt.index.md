...
Auto-generated index of all documents tagged with `#system-prompt`.
...
- `2026-02-18-system-prompt-architecture-research` - system-prompt research: architecture and tool-specific behavioral disparity
