...
# `packaging-restructure` feature index

Auto-generated index of all documents tagged with `#packaging-restructure`.
...
- `2026-02-21-packaging-restructure-p1p2-plan` - `packaging-restructure` `p1+p2` plan

### research

- `2026-02-21-packaging-restructure-research` - `packaging-restructure` research: `uv + unified MCP server`
