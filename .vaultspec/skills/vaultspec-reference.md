---
description: "Specialized skill for researching or implementing editor features by auditing the reference codebase. Coordinates with the `vaultspec-reference-auditor` sub-agent which audits and executes coding tasks."
---
