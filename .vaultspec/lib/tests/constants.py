...
#: Repository root (four directories above: tests/ -> lib/ -> .vaultspec/ -> repo)
PROJECT_ROOT: pathlib.Path = (
    pathlib.Path(__file__).resolve().parent.parent.parent.parent
)

#: .vaultspec/lib/src — the library source root
LIB_SRC: pathlib.Path = PROJECT_ROOT / ".vaultspec" / "lib" / "src"

#: .vaultspec/lib/scripts — CLI entry points
SCRIPTS: pathlib.Path = PROJECT_ROOT / ".vaultspec" / "lib" / "scripts"
