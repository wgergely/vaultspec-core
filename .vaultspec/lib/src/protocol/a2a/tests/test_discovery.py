...
from protocol.a2a.discovery import (
    generate_agent_md,
...
class TestGenerateAgentMd:
    ...
    def test_generate_agent_md_custom_description(self):
        ...
        assert "Vaultspec researcher agent via A2A protocol." not in md
...
class TestWriteAgentDiscovery:
    def test_write_agent_discovery_creates_file(self, tmp_path):
        ...
        result = write_agent_discovery(tmp_path, "researcher")

        expected = tmp_path / ".gemini" / "agents" / "researcher.md"
