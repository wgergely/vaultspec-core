...
0. **ADRs are king**: .vaultspec/README.md mandates a spec and ADR driven development pipeline. Internalize it's contents. Before any major feature request ask:
Did I read the .vaultspec/README.md? Does an existing ADR document exist related to the feature? Has the user provided enough context or is the feature small that I can proceed without an ADR? Prompt the user for clarification if uncertain.
